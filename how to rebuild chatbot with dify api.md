...
对话api：
curl -X POST 'http://156.224.28.114/v1/chat-messages' \
--header 'Authorization: Bearer app-cBHod54lb7bXLu1Pfvje6TLc' \
...
// files默认传空列表
// conversation_id在对话第一句为空，若在同一对话中继续问答，conversation_id要传第一句对话返回值中的conversation_id